            ...
            <tbody>
                @forelse($histories as $i => $hist)
                    ...
                    <tr>
                        ...
                        <td>
                            @if($user_status && $user_status->role == 1)
                        ...
                        <td>
                            @if(!$hist->approved && $user_status && $user_status->role == 1)
                    ...
                    <tr>
                        ...
                        <td><b> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-balloon-heart-fill text-danger" viewBox="0 0 16 16">
                            ...
                            </b>{{$likes->where('history_id', $hist->id)->count()}}
                        </td>
                        <td>
                            <div style="width: 6rem;">
                                &#x20AC; {{number_format(
                                    $moneys->where('history_id', $hist->id)->sum('money'), 2, '.', ' ')}}
                            </div>
                        </td>
                        <td>
                        </td>
